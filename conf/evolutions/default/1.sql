...
create table `contacts` (`id` BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,`kennitala` VARCHAR(254) NOT NULL,`name` VARCHAR(254) NOT NULL,`phone` VARCHAR(254) NOT NULL,`userEmail` VARCHAR(254) NOT NULL);
create table `demands` (`id` VARCHAR(254) NOT NULL,`user_email` VARCHAR(254) NOT NULL,`amount` INTEGER NOT NULL,`description` VARCHAR(254) NOT NULL,`status` VARCHAR(254) NOT NULL,`timestamp` TIMESTAMP NOT NULL);
create table `recipients` (`id` BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,`demandId` VARCHAR(254) NOT NULL,`name` VARCHAR(254) NOT NULL,`amount` INTEGER NOT NULL,`paid` BOOLEAN NOT NULL);
