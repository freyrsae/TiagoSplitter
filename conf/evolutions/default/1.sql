...
create table "contacts" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"kennitala" VARCHAR NOT NULL,"name" VARCHAR NOT NULL,"userEmail" VARCHAR NOT NULL,"drasl" VARCHAR NOT NULL);
