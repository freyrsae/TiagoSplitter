...
create table `demands` (`id` BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,`user_email` VARCHAR(254) NOT NULL,`amount` INTEGER NOT NULL,`per_person` BOOLEAN NOT NULL,`description` VARCHAR(254) NOT NULL,`status` VARCHAR(254) NOT NULL,`timestamp` TIMESTAMP NOT NULL);
